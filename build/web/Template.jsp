<%-- 
    Document   : Template
    Created on : Feb 5, 2019, 12:33:29 PM
    Author     : Tambun
--%>
...
<table border='0' bgcolor='#000080' align='top' width='100%' style='height:100px'>
    <tr>
        ...
        <td bgcolor='#000080' align='left' width='150'>
            <img src='images/companylogo_.png' width='200' height='120' align='right'/>
        </td>
    </tr>
</table>
<table bgcolor="white" border="0" align="top" width="100%" style="height:470px">
    <tr>
        <td style="width: 216px;" colspan="1" rowspan="4"><img style="width: 215px; height:560px; float:left" alt="" src="images/sidebar_.jpg">
        </td>
